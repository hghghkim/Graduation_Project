...
spectral_image1=SWIR_images_resize2(dark_name,white_name,name,500,1);
spectral_image(:,:,:)=fliplr(spectral_image1(:,30:450,:));% 좌우 대칭 변환
...
% k1=1;
% k2=1;
saving_folder='/Users/kimhangi/Data/Project/new_seeds_data/53'; % 저장 위치
...
%     imwrite(selected_data3,full_destination)
    save(full_destination, 'selected_data3_1')
