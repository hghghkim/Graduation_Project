...
function [Rc2,SEC,Rp2,SEP,PCn,Prediction_value,Prediction_R2,Prediction_SEP,Opimal_PCn1,BETA2,Cal_Prediction_value] = PLS_DA_SIMPLS (rowdata,Prediction_data1)
...
[~,~,~,~,~,PCTVAR1,MSE2] = plsregress(RX,RY,PCn,'cv',sr);

% 최적 변수 구하는 두번째 방법
% Optimal PC number
% Two condition
% 1. 전체 변량의 1% 이상을 설명할때 까지
% 2. Validation MSE 값이 상승하는 포인트 : 
% 3. 최저점까지 반복 : 최저점까지의 총 변수를 75% 설명하는 PCn
% 
Opimal_PCn1 = MSE2(2,:)';
